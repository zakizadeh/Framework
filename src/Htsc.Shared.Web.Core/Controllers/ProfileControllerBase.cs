...
using Htsc.Shared.Authorization.Users.Profile;
using Htsc.Shared.Authorization.Users.Profile.Dto;
using Htsc.Shared.Dto;
using Htsc.Shared.Storage;
using Htsc.Shared.Web.Helpers;

namespace Htsc.Shared.Web.Controllers
{
    public abstract class ProfileControllerBase : SharedControllerBase
    {
