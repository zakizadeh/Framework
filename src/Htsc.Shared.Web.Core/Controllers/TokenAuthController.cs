...
using Htsc.Shared.Authentication.TwoFactor;
using Htsc.Shared.Authentication.TwoFactor.Google;
using Htsc.Shared.Authorization;
using Htsc.Shared.Authorization.Accounts.Dto;
using Htsc.Shared.Authorization.Users;
using Htsc.Shared.MultiTenancy;
using Htsc.Shared.Web.Authentication.JwtBearer;
using Htsc.Shared.Web.Authentication.TwoFactor;
using Htsc.Shared.Web.Models.TokenAuth;
using Htsc.Shared.Authorization.Impersonation;
using Htsc.Shared.Authorization.Roles;
using Htsc.Shared.Configuration;
using Htsc.Shared.Identity;
using Htsc.Shared.Net.Sms;
using Htsc.Shared.Notifications;
using Htsc.Shared.Security.Recaptcha;
using Htsc.Shared.Web.Authentication.External;
using Htsc.Shared.Web.Common;
using Htsc.Shared.Authorization.Delegation;

namespace Htsc.Shared.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : SharedControllerBase
    {
